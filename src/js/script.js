...
class AuthSystem {
    ...
    updateNavigation() {
        ...
        if (navMenu) {
            ...
            const isOnAdminDashboard = window.location.pathname.includes(
            ...
            if (
                ...
                adminA.addEventListener("click", function () {
                    ...
                    setTimeout(() => {
                        const adminLink = navMenu.querySelector(
...
function initInlineEditing() {
    ...
    const enable = () => {
        ...
        authSystem &&
            authSystem.showMessage("Inline editing enabled", "success");
    };
    ...
    const onImageClick = async (e) => {
        ...
        try {
            ...
            if (!file) return;
            const url = await uploadImageInline(
                file,
            ...
            authSystem &&
                authSystem.showMessage("Image update failed", "error");
        }
    };
    ...
    saveBtn.addEventListener("click", async () => {
        try {
            ...
            authSystem &&
                authSystem.showMessage("Failed to save changes", "error");
        }
    });
